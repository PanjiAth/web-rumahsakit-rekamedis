<?php include_once('../_header.php');?>
    ...
    <div class="box">
        <h1>Dokter</h1>
        <h4>
            <small class="text-primary">Data Dokter</small>
                        ...
                        while($data = mysqli_fetch_array($sql_obat)){ ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="del.php?id=<?=$data['id_dokter']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ?')" class="btn btn-danger btn-xs" ><i class="glyphicon glyphicon-trash"></i></a>
                                </td>
                            </tr>
                        <?php
                        }
